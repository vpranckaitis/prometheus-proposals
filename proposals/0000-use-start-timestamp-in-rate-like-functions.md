...
![start_timestamps.png](../assets/0000-use-start-timestamp-in-rate-like-functions/start_timestamps.png)
...
Earlier paragraphs have described start timestamps of unbroken sequences. However, things become more complex when a sequence is restarted, which would likely lead to gaps in the timeseries not covered by any datapoints. Real life scenarios might also  
